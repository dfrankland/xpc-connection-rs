...
use super::{
    xpc_sys::{
        ...
        xpc_release,
        _xpc_type_activity,
        _xpc_type_array, xpc_array_apply, xpc_array_create, xpc_array_append_value,
        _xpc_type_bool,
        _xpc_type_connection,
        _xpc_type_data, xpc_data_get_bytes_ptr, xpc_data_get_length, xpc_data_create,
        _xpc_type_date,
        _xpc_type_dictionary, xpc_dictionary_apply, xpc_dictionary_create, xpc_dictionary_set_value,
        _xpc_type_double,
        _xpc_type_endpoint,
        _xpc_type_error,
        _xpc_type_fd,
        _xpc_type_int64, xpc_int64_get_value, xpc_int64_create,
        _xpc_type_null,
        _xpc_type_shmem,
        _xpc_type_string, xpc_string_get_string_ptr, xpc_string_create,
        _xpc_type_uint64,
        _xpc_type_uuid, xpc_uuid_get_bytes, uuid_t, xpc_uuid_create,
    }
};
...
pub fn xpc_object_to_xpctype(xpc_object: xpc_object_t) -> (XpcType, xpc_object_t) {
    ...
    check_xpctype!(xpc_object, xpc_object_type, [
...
pub fn xpc_object_to_message(xpc_object: xpc_object_t) -> Message {
    match xpc_object_to_xpctype(xpc_object).0 {
        ...
        XpcType::String => Message::String(cstring_to_string(unsafe { xpc_string_get_string_ptr(xpc_object) })),
        XpcType::Dictionary => {
...
pub fn message_to_xpc_object(message: Message) -> xpc_object_t {
    match message {
        ...
        Message::String(value) => {
            unsafe { xpc_string_create(string_to_cstring(value)) }
        },
